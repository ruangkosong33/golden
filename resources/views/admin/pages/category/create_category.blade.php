        ...
        <form class="form-horizontal" method="post" action="{{route('category.store')}}">
          ...
          <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control @error('title_category') is-invalid @enderror" id="title_category" placeholder="Judul Kategori" name="title_category" value="{{old('title_category')}}">
